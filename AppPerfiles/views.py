...
def agregar_avatar(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            avatar.save()
            return render(request, 'AppProyecto/profile.html', {'mensaje' : f'Tu avatar ha sido agregado', 'avatar' : obtener_avatar(request)})
        else:
...
def obtener_avatar(request):
    ...
    if len(avatares)!=0:
        ...
        return '/media/avatares/default_profile_pic.png'
